...
public class IdcheckioModule extends ReactContextBaseJavaModule implements IdcheckioCallback, IdcheckioInteractionInterface {
    ...
    @ReactMethod
    public void activate(String licenceFileName, Boolean extractData, Boolean disableAudioForLiveness,
                 String environment, Promise promise){
        this.mPromise = promise;
        if(this.getCurrentActivity() != null){
            Idcheckio.activate(licenceFileName, this, this.getCurrentActivity(), extractData, disableAudioForLiveness, SdkEnvironment.valueOf(environment));
        } else {
