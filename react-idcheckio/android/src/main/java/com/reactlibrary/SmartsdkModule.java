...
import com.ariadnext.android.idcheckio.bean.enums.AXTSdkParameters;
import com.ariadnext.android.idcheckio.enums.EnumExtraParameter;
import com.ariadnext.android.idcheckio.exception.CaptureApiException;
import com.ariadnext.android.idcheckio.interfaces.AXTCaptureInterface;
import com.ariadnext.android.idcheckio.interfaces.AXTCaptureInterfaceCallback;
import com.ariadnext.android.idcheckio.interfaces.bean.AXTDataExtractionRequirement;
import com.ariadnext.android.idcheckio.interfaces.bean.AXTDocumentType;
import com.ariadnext.android.idcheckio.interfaces.bean.AXTSdkInit;
import com.ariadnext.android.idcheckio.interfaces.bean.AXTSdkParams;
import com.ariadnext.android.idcheckio.interfaces.bean.AXTSdkResult;
import com.ariadnext.android.idcheckio.utils.EnumUtils;
...
public class SmartsdkModule extends ReactContextBaseJavaModule implements AXTCaptureInterfaceCallback {
    ...
    public void capture(ReadableMap map, Promise captureCallback){
        ...
        if(getCurrentActivity() != null) {
            ...
            if(this.isActivated){
                try {
                    final Intent idcheckio = AXTCaptureInterface.INSTANCE.getIntentCapture(this.getCurrentActivity().getApplicationContext(), params);
                    this.getCurrentActivity().startActivityForResult(idcheckio, SDK_REQUEST_CODE, null);
